          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 text-left">
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <p 
                ...
                className="text-[#0F1E2E]/85 select-text"
              >
                <strong className="font-bold">Swiss Peptides</strong> (<a href="https://buyswisspeptides.shop" target="_blank" rel="noopener noreferrer" className="hover:text-[#DE5246] transition-colors underline decoration-[#DE5246]/30">https://buyswisspeptides.shop</a>) is truly <strong className="font-bold">customer-focused</strong>, offering support that goes beyond simply providing products. Understanding that purchasing and using peptides can raise questions, their team is dedicated to guiding customers with clear information, prompt responses, and professional advice. From helping navigate product options to ensuring smooth ordering and delivery, every interaction is designed to make the experience seamless and reassuring. By prioritizing customer needs, addressing concerns quickly, and providing reliable guidance, they build trust and confidence, showing that excellent support is as important as the quality of the peptides themselves.
              </p>
            </div>
